...
export default function Servico() {
  ...
  function abrirDetalhes(nome, imagem, descricao) {
    const url = `/pop?nomeProd=${encodeURIComponent(
      nome
    )}&imagemProd=${encodeURIComponent(
      imagem
    ...
    <>
      ...
      <main>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="descricao">
              Massagens com óleos orgânicos em cabines de vidro com vista para a
              floresta.
            </p>
        ...
        <div className="container">
          ...
          >
            <img
              src={sliders.trilha[0]}
              alt="Trilhas Guiadas com Piquenique Gourmet"
            />
        ...
        <div className="container">
          ...
          >
            ...
            <span className="preco">R$ 600 por pessoa (com harmonização).</span>
          </div>
        </div>
        ...
        <div className="container">
          ...
          >
            ...
            <span className="preco">R$ 250 por pessoa.</span>
          </div>
        </div>
        ...
        <div className="container">
          ...
          >
            ...
            <span className="preco">R$ 1.200 (até 6 pessoas).</span>
          </div>
        </div>
        <div className="container">
          <div
          ...
          >
            ...
            <span className="preco">R$ 400 (1h30, casal).</span>
          </div>
        </div>
